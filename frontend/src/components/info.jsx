...
function Info ({title, subTitle}) {
  ...
  return (
  <div className="flex flex-col md:flex-rpw md:items-center justify-between py-8">
    ...
    <div className="flex items-center gap-4 md:gap-10 2xl:gap-20">
      <div className="flex items-center gap-2 border border-gray-300
       dark:border-gray-600 rounded-md p-2">
      ...
      <button className="flex items-center gap-2 bg-black 
        dark:bg-violet-800 py-2 px-4 rounded text-white">
